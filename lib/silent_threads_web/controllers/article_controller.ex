defmodule SilentThreadsWeb.ArticleController do
  use SilentThreadsWeb, :controller

  alias SilentThreads.News
  alias SilentThreads.News.Article

  action_fallback SilentThreadsWeb.FallbackController
